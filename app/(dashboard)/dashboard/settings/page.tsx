    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          <h2 className="text-base font-semibold text-foreground">Основная информация</h2>
        ...
        {/* Location */}
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          <h2 className="text-base font-semibold text-foreground">Местоположение</h2>
        ...
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">Вебсайт</label>
              <input
                type="url"
                value={form.website}
        ...
        {/* Operations */}
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          <h2 className="text-base font-semibold text-foreground">Операционные настройки</h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">Заезд</label>
              <input
                type="time"
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">Выезд</label>
              <input
                type="time"
        ...
        {/* Amenities */}
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          <h2 className="text-base font-semibold text-foreground">Удобства</h2>
        ...
        {/* Booking settings */}
        <section className="bg-card rounded-xl border border-border p-6 space-y-5">
          <h2 className="text-base font-semibold text-foreground">Настройки бронирования</h2>
        ...
        <div className="flex items-center justify-between">
          <a
            ...
            download
            className="flex items-center gap-2 border border-border hover:bg-muted text-foreground font-medium px-4 py-2.5 rounded-lg transition-colors text-sm"
          >
